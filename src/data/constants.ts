...
export const INTEREST_PROFILES_DETAIL: { [key: string]: InterestResult } = {
    ...
    C: { 
        ...
        weaknesses: ["Kurang menyukai ambiguitas atau perubahan mendadak", "Cenderung kaku dan kurang fleksibel", "Mungkin kurang nyaman dengan peran kepemimpinan", "Cenderung menghindari tugas yang sangat terstruktur atau kreatif"],
    },
};

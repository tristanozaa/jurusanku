...
if (supabaseUrl === "YOUR_SUPABASE_URL" || supabaseAnonKey === "YOUR_SUPABASE_ANON_KEY") {
    ...
    console.warn("Peringatan: URL dan Anon Key Supabase belum dikonfigurasi. Silakan perbarui file 'services/supabase.ts' dengan kredensial proyek Anda agar aplikasi berfungsi.");
}
